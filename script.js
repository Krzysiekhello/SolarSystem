...
class Planets {
    ...
    update = (earth) => {
        this.horizontalPosition = this.radius * Math.cos((this.angle + 15) * (Math.PI/180)) + windowWidth - this.width / 2;
...
const mercury = new Planets(0,0, 10, 10,"img/mercury.png", 2, 60, 20);
const venus = new Planets(0,0, 24, 24,"img/venus.png", 1.5, 90, 64);
const earth = new Planets(0,0, 25, 25,"img/earth.png", 1.3, 140, 29);
const moon = new Planets(0,0, 10, 10,"img/moon.png", 4, 25,124);
const mars = new Planets(0,0, 14, 14,"img/mars.png", 1, 189, 42);
const jupiter = new Planets(0,0, 70, 70,"img/jupiter.png", 0.50, 260, 232);
const saturn = new Planets(0,0, 110, 70,"img/saturn.png", 0.42, 360, 0);
const uranus = new Planets(0,0, 45, 45,"img/uranus.png", 0.30, 440,-20);
const neptune = new Planets(0,0, 40, 40,"img/neptune.png", 0.20, 500, 20);
